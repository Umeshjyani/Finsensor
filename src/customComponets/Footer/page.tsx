            ...
            <div className="bg-gray-50 h-1/2 w-full flex md:flex-row flex-col justify-around item-start p-16" >
                ...
                <div className='p-5'>
                    <ul>
                        ...
                        <li className='text-gray-600 pb-2 font-semibold hover:text-blue-600 cursor-pointer'>Lease Accounting Solution</li>
                ...
                <div className='p-5'>
                    <ul>
                        ...
                        <li className='text-gray-600 pb-2 font-semibold hover:text-blue-600 cursor-pointer'>Headquartered in Delhi, India</li>
                        <li className='text-gray-600 pb-2 font-semibold hover:text-blue-600 cursor-pointer'>Address </li>
                        <li className='text-gray-600 pb-2 font-semibold hover:text-blue-600 cursor-pointer'>Phone </li>
                        <li className='text-gray-600 pb-2 font-semibold hover:text-blue-600 cursor-pointer'>Email</li>
